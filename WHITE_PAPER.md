...
│   ├── anti\_pattern\_filter.py  # Algoritmos de validación PII y vetos

│   ├── rule\_templates.py       # Matriz de reglas bancarias y móviles

│   └── password\_generator.py   # Motor de aleatoriedad CSPRNG

└── gui/

└── app\_window.py          # Interfaz reactiva (CustomTkinter)
